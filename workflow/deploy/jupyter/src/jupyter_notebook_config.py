...
#  local as well.
c.NotebookApp.local_hostnames = ['localhost','jupyter.nano-one.local','jupyter.polarize.ai']
...
#c.NotebookApp.password = 'sha1:cb737bebef5f:22f27f49b30865299d78949ec33faac1b9c5785a'
